...
def test_create_booking(booking_manager, booking_data, all_schemas):
    ...
    receive_and_check_booking_id(booking_id=booking_id, booking_manager=booking_manager, booking_data=booking_data)
    ...
    deleted_booking_status_code = booking_manager.receive_current_booking(booking_id=booking_id)
